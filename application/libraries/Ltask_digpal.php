...
class Ltask {
	...
	public function update_microkey_client($taskID = null, $userInfo = null){
        ...
        if(!empty($submitData)) {
           ...
           // print_r($table_data); die;
            $result = $CI->Tasks->update_microkey_client($taskID, $table_data);
            if($result) {
  ...
  $postData['uploadFiles'] = array();
	...
	public function edit_microkey_client_test($taskID = null, $userInfo = null){
