...
class Ltask {
  ...
  $postData['uploadFiles'] = array();
	...
	public function edit_microkey_client($taskID = null, $userInfo = null){
        	...
        	'id' => $task_details->id,'user_id' => $task_details->user_id,
    									'title' => $task_details->title,'skills' => $user_skills,
    										...
    										'continent' => $continent->name,
    											'country' => $country->name,'duration' => $task_details->duration,
    												'duration_type' => $task_details->duration_type,'description' => $task_details->description,
