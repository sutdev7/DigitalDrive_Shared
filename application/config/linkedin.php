...
*/
$config['linkedin_api_key']       = '86aacohhj6tfpf';
$config['linkedin_api_secret']    = 'CuwtfStwbZSe9D63';
$config['linkedin_redirect_url']  = 'https://www.drivedigitally.com/hirenwork/linkedin_login/login';
$config['linkedin_scope']         = 'r_basicprofile r_emailaddress';//r_basicprofile 