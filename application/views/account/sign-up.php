          ...
          <div class="singUpDiv">
            ...
            <form action="<?php echo base_url(); ?>confirm-sign-up" name="frmSignUp" id="frmSignUp"  enctype="multipart/form-data" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="fldName" name="fldName" placeholder="Enter Name" value="" data-toggle="tooltip" title="" required>
                <b class="text-danger">Name will be unique</b>
              </div>
              <div class="form-group">
                <label>Enter username </label>
                <input type="text" class="form-control" id="username" name="username" data-placement="top"  data-toggle="tooltip" title="" placeholder="Enter Username" value="" required>
                <b class="text-danger">Username will be unique , so choose ur username consciously</b>
              </div>
              <div class="form-group">
                <label>Select Country</label>
                <select id="fldCountry" name="fldCountry" value="" required>
                  <option value="">Select Country</option>
                  {countries} <option value="{key}" data-id="{c_code}">{value}</option> {/countries}                 
                </select>
              </div>
              ...
              <div class="form-group">
                <span>
                  ...
                  <input type="password" class="form-control" id="fldPassword" name="fldPassword" data-placement="top" data-toggle="tooltip" title="" placeholder="Enter Password" value="" required>

                  <b class="text-danger">Password should be, Capital, small, number & special character combination with 8 digit.</b>
                </span> 
              </div>         
			         <div class="form-group"> 
                <span>
                  <label>Choose country code then number</label>
                  <div class="form-group"> 
                      <input id="phone" type="tel" name="phone_no" placeholder="Mobile No" class="form-control" placeholder="Mobile No" value="" required>  
                  </div>
                ...
                <div class="form_upload">
                  <div class="file-upload-wrapper" data-text="Upload profile picture">
                    <input name="userImage" type="file" class="file-upload-field" value="" id="cv_upload">
                  </div>
                </div>
