...
$profile_status=$notifications[0]->profile_status;
...
<!--                                        <p class="mb-1">Proposal <b> {proposal_count}</b></p>
                ...
                <div class="col-lg-4">
                    <div class="task_Right_Div free" style="margin-top: 0px;">
                        <?php
                        if ($hire_me == true) {
                            ?>
                            ...
                            <form action="<?= base_url() . 'proposal' ?>" method="post">
                               ...
                               <!-- <input type="submit" value="Submit Proposal" class="eyeBtn" style="margin: 25px 0 0px 0;">-->
								<?php 
								if($profile_status == 0){ ?>
								 <a href="#ProfileNotification" data-toggle="modal"><input type="submit" value="Submit Proposal" class="eyeBtn" style="margin: 25px 0 0px 0;"></a>
								<div class="modal editingModal" id="ProfileNotification">
									  <div class="modal-dialog modal-sm">
										<div class="modal-content"> 
										  <form name="frmSaveUserInfo" class="userInfo" method="post" action="<?php echo base_url(); ?>user/saveUserData" >
											<!-- Modal Header -->
											<div class="modal-header">Profile Status
											  <button type="button" class="close" data-dismiss="modal">&times;</button>
											</div>
											<!-- Modal body -->
											<div class="modal-body">
											  <p><?php if(empty($user_info[0]->bio)){?>
													 complete the freelancer bio you cant be access any or mikro key list. so you need to complete the  bio first <a href="<?php echo base_url(); ?>edit-profile">Click here</a>

													<?php }else{ ?>
													Untill profile active u can't be send any proposal. Please fill up your profile details and wait for admin approval 
													<?php } ?>
