                      ...
                      <div class="card-body">
                          <div class="projects" data-task_id>
                            <ul class="list-group list-group-flush text-gray-800">
                              ...
                              <li class="list-group-item" data-task_id="<?= $value->task_id ?>"><?= $count?>. <?= $value->task_name ?></li>
                              <?php endforeach ?>
                            </ul>
                            <?php if($count > 5): ?>
                              ...
                              <div class="input-group-sec mr-0 float-right">
                                <div class="input-group">
                                  <div class="input-group-btn">
                                    <a href='<?= base_url('Freelancer/see_all_projects') ?>' class="btn btn-default p-2 text-primary font-weight-bold">See More</a>
                                  </div>
                                </div>
                              </div>
                            </div>
