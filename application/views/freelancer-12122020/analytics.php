                  ...
                  <?php //echo '<pre>'; print_r($analytics); ?>
                    ...
                    <div class="card shadow mb-4">
                      <div class="card-header py-3">
                        ...
                        <a href="<?php echo base_url('job-list/completed')?>" style="float:right;">View All</a>
                      </div>
                      <div class="card-body">
                        ...
                        <?php foreach($analytics as $key => $value): ?>
                          ...
                          <?php if($count == 6) break; ?>
                            <!-- <div class="projects" data-task_id="<?= $value->task_id ?>"> -->
                              ...
                              <li class="list-group-item projects" data-task_id="<?= $value->task_id ?>"><?= $count?>. <?= $value->task_name ?></li>
                            <!-- </div> -->
                          <?php endforeach ?>
                          </ul>
                          <?php if(count($analytics) > 5): ?>
