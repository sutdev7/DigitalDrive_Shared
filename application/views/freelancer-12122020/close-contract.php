      ...
      <div class="total-boddiv">
        ...
        <div class="back-white back-white-two">
          ...
          <div class="radiodiv">
            <ul>
              ...
              <li>
                <label class="containerdiv">Mark as complete
                  <input type="radio" checked="checked" name="action" value="complete" >
			...
			<ul>
			  <li>
                <label class="containerdiv"> <small> 0 Coin </small>
                  <input type="radio"  name="coin" value="0" required >
                  <span class="checkmark"></span> </label>
				  
				   <label class="containerdiv"> <small> -1 Coins </small>
                  <input type="radio"  name="coin" value="-1" >
                  <span class="checkmark"></span> </label>
              </li>
			  
			    <li>
                <label class="containerdiv"> <small> +1 Coin </small>
                  <input type="radio"  name="coin" value="1" >
                  <span class="checkmark"></span> </label>
				  
				  <label class="containerdiv"> <small> +2 Coins </small>
