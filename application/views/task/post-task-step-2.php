        ...
        <div class="col-lg-12">
          ...
          <form action="<?php echo base_url(); ?>post-task-Step-3" name="frmPostTaskSecond" method="post">
            ...
            <div class="step_Box step_Box2">
              <h3>From which location you want to hire Freelancer?</h3>
              <h3>Location</h3>
              <ul>
                <li>
                  ...
                  <div id="datepicker" class="input-group date" data-date-format="mm-dd-yyyy">
					...
					<div class="row">
                                            <div class="col-lg-8">
                                                ...
                                                <input class="form-control" style="width: 100%;" type="number" name="flddurationfield"  placeholder="Enter Here" required>
                                            </div>
                                            <div class="col-lg-4 select-style" style="height: 47px;margin-top: 28px;">
                                                <select name="flddurationtype" style="width: 118%;margin-left: -13px;" required>
                                                    <option  value="">Select</option>
