                                    ...
                                    <?php if ( isset($user_message) && !empty($user_message)) { ?>
                                        ...
                                        foreach ($user_message as $key => $row) { ?>
                                            <tr>
                                                ...
                                                <td><?= $row->name ?></td>
                                                <td><a href="<?= base_url() ?>admin/outbox-view-messages/<?php echo $row->user_id; ?>/<?php echo $type_id; ?>" title="View Details"><i class="fa fa-eye"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                            $count++;
