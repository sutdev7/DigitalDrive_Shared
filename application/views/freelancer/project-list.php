                  ...
                  <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                      <div class="card-body">
                        <div class="row no-gutters align-items-center">
                          <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Tasks(Monthly/Yearly)</div>
                            <div class="row no-gutters align-items-center">
                              <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{yearly_projects}/{monthly_projects}</div>
                              </div>
                              <div class="col">
                    ...
                    <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                        ...
                        <div class="mt-4 text-center small">
                          <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Invitation
                          </span>
                       <!--   <span class="mr-2">
                          ...
                          <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Microkey Projects
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <?php //echo '<pre>'; print_r($analytics); ?>
                    ...
                    <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                        ...
                        <div class="projects" data-task_id="<?= $value->task_id ?>">
                            <h4 class="small font-weight-bold web"><?= $count?>. <?= $value->task_name ?>

                            <?php //echo date('F',$value->task_completion_date);
                            //$data[] = array_search('8',date('F',$value->task_completion_date)) ?>
                            <?php /*if(isset($no_web)){ ?>
                              <span class="float-right"><?php echo $no_web>0 ? $no_web : ''; ?></span>
                              <?php } */?>
                            </h4>
                            <?php /* ?>
                          <div class="progress mb-4 web">
                            <div class="progress-bar bg-danger" role="progressbar" <?php if(isset($no_web)){ ?> style="width: <?php echo $no_web; ?>%" <?php } ?> aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div><?= */ ?>
                            </div>
                          <?php endforeach ?>
                          <?php if($count > 5): ?>
                                ...
                                <div class="input-group-sec mr-0 float-right">
                                  <div class="input-group">
                                    <div class="input-group-btn">
                                      <a href="<?= base_url('Freelancer/see_all_projects') ?>" class="btn btn-default">See More</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
